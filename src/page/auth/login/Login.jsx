...
const validationSchema = Yup.object().shape({
  email: Yup.string().email("អ៊ីម៉ែលមិនត្រឹមត្រូវ").required("អ៊ីម៉ែលចាំបាច់ត្រូវបញ្ចូល"),
  password: Yup.string()
    .test("is-strong", function (value) {
      ...
      if (!/^(?=.*[!@#$%^&*])/.test(value))
        errors.push("សញ្ញាមួយ");
      if (value && value.length < 6) errors.push("យ៉ាងហោចណាស់ត្រូវមាន ៦ តួអក្សរ");
          ...
          >
            <Form>
              ...
              <div className="flex flex-col space-y-4 mt-4">
                ...
                <button className="flex items-center justify-center w-full px-5 py-2.5 rounded-lg ring-2 ring-[#222162] ring-inset text-gray-500 bg-white text-lg font-semibold hover:bg-[#222162] hover:text-white transition duration-300 ease-in-out">
